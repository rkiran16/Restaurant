  ...
  menu: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Crispy turnovers with seasoned potatoes and green peas",
          price: "$3.95"
        }
      ]
    },
      ...
      items: [
        {
          ...
          description: "Butter Fried cauliflower with ginger, garlic and onion",
          price: "$9.99"
        },
        {
        ...
        },
        {
          ...
          description: "Win tossed noodles with ginger, garlic and soya sauce",
          price: "$9.99"
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Indian style pancakes with Onion and Chili toppings",
          price: "$8.99"
        },
        {
